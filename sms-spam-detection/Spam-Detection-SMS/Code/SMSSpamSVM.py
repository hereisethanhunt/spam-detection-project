...
def ham():
        hamFile = "/home/vishal/Desktop/spam-detection-project/sms-spam-detection/Spam-Detection-SMS/Datasets/ham.txt";
        fileOpen = open("/home/vishal/Desktop/spam-detection-project/sms-spam-detection/Spam-Detection-SMS/Datasets/hamStatistics.txt","w")
        hamTokens = {}
...
def spam():
        spamFile = "/home/vishal/Desktop/spam-detection-project/sms-spam-detection/Spam-Detection-SMS/Datasets/spam.txt";
        fileOpen = open("/home/vishal/Desktop/spam-detection-project/sms-spam-detection/Spam-Detection-SMS/Datasets/spamStatistics.txt","w")
        spamTokens = {}
...
def dataSet():
        dataFile = "/home/vishal/Desktop/spam-detection-project/sms-spam-detection/Spam-Detection-SMS/Datasets/SMSSpamCollection";
        fileOpen = open("/home/vishal/Desktop/spam-detection-project/sms-spam-detection/Spam-Detection-SMS/Datasets/dataSetStatistics.txt","w")
        totalTokens = {}
...
# Spam - 1 ham - 0
def convert():
        outputFile = "/home/vishal/Desktop/spam-detection-project/sms-spam-detection/Spam-Detection-SMS/Datasets/SMSSpamCollection"
        output = open("/home/vishal/Desktop/spam-detection-project/sms-spam-detection/Spam-Detection-SMS/Datasets/output.txt", "w")
        tokens = []
...
def readOutput():
        outputFile = open("/home/vishal/Desktop/spam-detection-project/sms-spam-detection/Spam-Detection-SMS/Datasets/output.txt","r")
...
fileOpen = open("/home/vishal/Desktop/spam-detection-project/sms-spam-detection/Spam-Detection-SMS/Datasets/outputFeature.txt","w")
featureVector = features(hamDict,spamDict,fileOpen)
#print featureVector

# Input conversion
# For the total file
fileName = "/home/vishal/Desktop/spam-detection-project/sms-spam-detection/Spam-Detection-SMS/Datasets/SMSSpamCollectionFull.txt"
totalInput = inputConversion(featureVector, fileName)
# For the ham messages
fileName = "/home/vishal/Desktop/spam-detection-project/sms-spam-detection/Spam-Detection-SMS/Datasets/hamFull.txt"
hamInput = inputConversion(featureVector, fileName)
# For the spam messages
fileName = "/home/vishal/Desktop/spam-detection-project/sms-spam-detection/Spam-Detection-SMS/Datasets/spamFull.txt"
spamInput = inputConversion(featureVector, fileName)
print "\n\nThe input is converted to matrix!!"
#print X

# Write the input and output to a file
fileInput = open("/home/vishal/Desktop/spam-detection-project/sms-spam-detection/Spam-Detection-SMS/Datasets/inputWeka.csv","w")
with fileInput as f:
    writer = csv.writer(f)
